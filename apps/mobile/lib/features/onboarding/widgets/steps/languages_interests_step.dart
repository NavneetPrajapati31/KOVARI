...
class LanguagesInterestsStep extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final interestOptions = [
      "Travel", "Hiking", "Food", "Photography", "Music", "Fitness",
      "Yoga", "Cycling", "Cooking", "Art", "Museums", "Movies",
    ];
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
            ...
            child: Wrap(
              ...
              children: languageOptions.map((lang) {
                return SelectChip(
                  ...
                  onTap: () => ref.read(onboardingProvider.notifier).toggleLanguage(lang),
                );
              }).toList(),
            ),
          ),
          ...
          PrimaryButton(
            text: 'Continue',
            onPressed: (state.languages.isNotEmpty && state.interests.isNotEmpty)
          ...
          const SizedBox(height: 8),
          TextButton(
            onPressed: () => ref.read(onboardingProvider.notifier).setStep(4),
            child: Text(
              'Back',
              style: AppTextStyles.bodyMedium.copyWith(color: AppColors.mutedForeground),
            ),
