  ...
  return (
    <div className="min-h-screen bg-[#F6ECD9] text-[#004831] px-6 py-12">
      <div className="max-w-xl mx-auto bg-[#E1DBCA] p-8 rounded-xl shadow-md">
        ...
        <p className="text-[#5C6249] text-center mb-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {errors.mode && (
            <p className="text-sm text-red-600 mb-4">{errors.mode.message}</p>
          )}
          ...
          <div className="flex justify-between mt-6">
            <button
              type="button"
              className="px-4 py-2 border border-[#004831] rounded text-[#004831] hover:bg-[#ECEABE]"
            >
              Back
            </button>
            <button
              type="submit"
              className="px-4 py-2 bg-[#004831] text-white rounded hover:bg-[#003527]"
            >
              Continue
            </button>
          </div>
