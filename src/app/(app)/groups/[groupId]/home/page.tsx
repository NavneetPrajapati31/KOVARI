...
const GroupHomePage = () => {
  ...
  return (
    <>
      ...
      {/* Tablet Layout */}
      <div className="xl:hidden flex flex-col h-full bg-background text-foreground px-0">
        {/* Mobile Content - Vertical Stack */}
        <div className="flex-1 overflow-y-auto">
          {/* Group Info + Members */}
          <div>
            <Card className="bg-card border-1 border-border rounded-3xl shadow-sm mt-3">
              <CardBody className="p-4">
                {/* Image Cards */}
                <div className="space-y-4 mb-4">
                  {groupInfoLoading ? (
                    ...
                    <div className="flex flex-row gap-2">
                      ...
                      {/* AI Overview */}
                      <Card className="bg-primary-light border-3 border-card rounded-3xl shadow-sm flex-1 basis-1/2">
                        <CardBody className="p-4">
                          <h3 className="text-xs font-semibold text-primary mb-2">
                            AI Overview
                          </h3>
