            ...
            >
              {steps.map((step, index) => (
                <motion.div
                  ...
                  className="group relative rounded-3xl bg-card p-6 sm:p-8 text-center flex flex-col h-full border border-border"
                >
                  {/* Step number - circular container at top center */}
                  <div className="mx-auto mb-5 sm:mb-6 flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-card border border-border text-sm sm:text-base font-semibold text-primary">
                    {step.number}
                  </div>
