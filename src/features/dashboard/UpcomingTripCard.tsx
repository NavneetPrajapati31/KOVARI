...
export function UpcomingTripCard({
  ...
  return (
    <Card
      className={`relative w-[260px] h-[200px] rounded-3xl sm:rounded-3xl md:rounded-3xl lg:rounded-3xl shadow-sm border-3 border-card overflow-hidden flex flex-col bg-card text-card-foreground`}
    >
